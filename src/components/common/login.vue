  ...
  <div class="login" v-if="display">
    <div class="loginBox">
      ...
      <div>
        ...
        <p v-if="!valify && a" style="color: red">
          <i class="el-icon-close"></i>账号格式错误
        </p>
      </div>
      <div>
        ...
        <p v-if="!valifyP && p" style="color: red">
          <i class="el-icon-close"></i>密码格式错误
        </p>
      </div>
...
export default {
  ...
  methods: {
    loginBox() {
      ...
      if (cookie.length > 1) {
        this.input1 = parseInt(cookie[0]);
        this.input2 = cookie[1];
      }
    },
    verifyID() {
      this.a = true;
